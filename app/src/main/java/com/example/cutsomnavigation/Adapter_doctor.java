...
public class Adapter_doctor extends RecyclerView.Adapter<Adapter_doctor.ViewHolder> {

    private List<ModelClass> userList;

    public Adapter_doctor(List<ModelClass>userList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_design_doctor,parent,false);
